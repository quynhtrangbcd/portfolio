        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-8">
            ...
            <p className="text-secondary leading-relaxed text-lg">
              As a Business Analyst with over three years of in-depth experience in the ERP field, I have participated in multiple projects involving the implementation and optimization of ERP systems for businesses across various industries, including spa, technology, and seafood processing.
            </p>
            <p className="text-secondary leading-relaxed">
              I excel in gathering, analyzing, and identifying business requirements to develop suitable IT solutions that enhance operational efficiency and reduce costs. I have hands-on experience working with Odoo ERP software, optimizing processes related to sales and purchase management, finance, inventory, and production.
            </p>
             <p className="text-secondary leading-relaxed">
              My strong communication and teamwork skills enable me to connect effectively with different departments and present solutions clearly. I am passionate about process improvement and technology application to contribute to the sustainable growth of an organization.
            </p>
            ...
            <div className="flex flex-wrap gap-3">
              {['ERP Implementation', 'Seafood Processing', 'Technology', 'Spa & Beauty', 'SaaS', 'Logistics'].map((industry) => (
